...
function gui_mail_ve($load_ve_tt) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'vominhtien10092002@gmail.com';
        $mail->Password   = 'sswi txvk dqes cwap';
        $mail->SMTPSecure = PHPMailer\PHPMailer\PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        // Email người gửi
        $mail->setFrom('vominhtien10092002@gmail.com', 'CinePass');
        $mail->addAddress($_SESSION['user']['email']);

        // Nội dung
        $mail->isHTML(true);
        $mail->Subject = 'Thank you for booking movie tickets';
        $mail->Body    = 'Xác nhận Đặt Vé Xem Sự Kiện Thành Công <br><hr>

                               Chào '.$_SESSION['user']['name'].',

                            Chúc mừng! Đơn đặt vé của bạn đã được xác nhận thành công. 
                             Dưới đây là thông tin chi tiết về đơn đặt vé của bạn:<br>
                             - Mã đặt vé: ' . $load_ve_tt['id'] . ' <br>
                             - Tên sự kiện: ' . $load_ve_tt['tieu_de'] . '<br>
                             - Nhà hát : TIAM EVENTS <br>
                             ...
                             <hr>
                              ...
                              Chúng tôi xin thông báo rằng quý khách cần đến sớm trước giờ chiếu để có đủ thời gian kiểm tra vé và chọn chỗ ngồi thoải mái.<br>
                                Quý khách có thể sử dụng mã đặt vé trên để kiểm tra thông tin vé tại quầy vé hoặc tại các máy tự động trong nhà hát.<br>
                                  Nếu quý khách có bất kỳ thắc mắc nào hoặc cần hỗ trợ thêm, xin vui lòng liên hệ với chúng tôi qua số điện thoại 0366508004 hoặc email ngocvan@gmail.com.<br>
                                  Chúng tôi rất mong đợi sự xuất hiện của bạn và hy vọng bạn sẽ có một trải nghiệm thú vị tại nhà hát của chúng tôi.<br>
