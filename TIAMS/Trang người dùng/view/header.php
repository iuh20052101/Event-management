    ...
    <header class="header-wrapper header-wrapper--home">
        <div class="container">
            ...
            <a href='index.php' class="logo">
                <img alt='logo' src="imgavt/logo1.png">
            </a>
            ...
            <nav id="navigation-box">
                ...
                <ul id="navigation">
                    ...
                    <li>
                        <span class="sub-nav-toggle plus"></span>
                        <a href="index.php?act=dsphim1&sotrang=1">Sự kiện</a>
                        <ul>
                            <li class="menu__nav-item"><a href="index.php?act=phimdangchieu" >Tất cả Sự kiện</a></li>
                        </ul>
                    </li>
