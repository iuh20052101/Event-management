...
<section class="container">
    <div class="col-sm-12">
        <h2 class="page-heading">Danh sách sự kiện  /
            <span >Sự kiện đang có </span></h2>
                ...
                <div class="movie movie--preview movie--full comments">
                    ...
                    <div class="col-sm-9 col-md-10 col-lg-10 movie__about">
                        ...
                        <div class="movie__btns">
                            <a href="<?=$book1?>" class="btn btn-md btn--warning">Đặt Vé <span class="hidden-sm">Xem Sự Kiện</span></a>
                        </div>
