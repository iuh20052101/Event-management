                    ...
                    echo '
                       <div class="ticket">
                        <div class="ticket-position">
                            <div class="ticket__indecator indecator--pre"><div class="indecator-text pre--text">CTIAM EVENTS</div> </div>
                            <div class="ticket__inner">
                                ...
                                <span class="ticket__item ticket__item--primery ticket__film" style="display:flex;> <strong class="ticket__movie" >SỰ KIỆN : ' . $tieu_de . '</strong></span>                                    
