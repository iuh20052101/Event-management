    ...
    <div class="row justify-content-between align-items-center mb-10">
        ...
        <form action="index.php?act=ve" method="post">
            <div class="otk"><input type="text" class="tki" name="ten" placeholder="Tìm kiếm người dùng">
                <input type="text" class="tki1" name="tieude" placeholder="Tìm kiếm sự kiện">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                switch ($ve['trang_thai']) {
                                    case '0':
                                        echo '<span class="badge badge-danger">Đang chờ</span>';
                                        break;
                                    case '1':
                                        echo '<span class="badge badge-success">Xác nhận vé thành công</span>';
                                        break;
                                    case '2':
