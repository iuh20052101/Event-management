...
<div class="content-body">
    ...
    <div class="row mbn-30">
        ...
        <div class="news-item">
                <div class="content">
            <div class="categories"><a href="index.php?act=themloai" class="product">Thêm Loại Sự Kiện</a></div></div></div>
                    ...
                    <tbody>
                        ...
                        <td>
                            <div class="table-action-buttons">
                                ...
                                <a class="delete button button-box button-xs button-danger" href="'.$linkxoa.'" onclick="return confirm(\'Xác nhận xóa\')"><i class="zmdi zmdi-delete"></i></a>
                            </div>
                        </td>
                        </tr>';
                        } ?>
