    ...
    <div class="row justify-content-between align-items-center mb-10">
        ...
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3>Loại Sự Kiện <span>/ Sửa</span></h3>
            </div>
    ...
    <form action="index.php?act=updateloai" method="POST">
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                ...
                <h4 class="title">Sửa loại Sự kiện</h4>

                <div class="row">
                    <div class="col-lg-6 col-12 mb-30"><input class="form-control" type="text" placeholder="Nhập loại Sự kiện" name="name" value="<?=$name?>"></div>
