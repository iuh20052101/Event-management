...
<?php 
            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Quản Lý Sự Kiện  <span>/ Danh Sách Sự Kiện</span></h3>
                    </div>
                </div><!-- Page Heading End -->
                <form action="index.php?act=QLphim" method="post">
            <div class="otk"><input type="text" class="tki" name="ten" placeholder="Tìm kiếm tên Sự kiện">
                <input type="text" class="tki1" name="loai" placeholder="Tìm kiếm loại Sự kiện">
    ...
    ?> 
            <div class="row mbn-30">
                ...
                <div class="news-item">
                <div class="content">
                <div class="categories"><a href="index.php?act=themphim" class="product">Thêm Sự Kiện</a></div></div></div>
                    <div class="table-responsive">
                        ...
                        <td>
                            <div class="table-action-buttons">
                                ...
                                <a class="delete button button-box button-xs button-danger" href="'.$linkxoa.'" onclick="return confirm(\'Xác nhận xóa sự kiện\')"><i class="zmdi zmdi-delete"></i></a>
                            </div>
                        </td>
                        </tr>';
                        } ?>
