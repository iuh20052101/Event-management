    ...
    <div class="row justify-content-between align-items-center mb-10">
        ...
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3> Sự Kiện <span>/ Sửa Sự Kiện</span></h3>
            </div>
    ...
    <form action="index.php?act=updatephim" method="POST" enctype="multipart/form-data">
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                ...
                <h4 class="title">Sửa Sự kiện</h4>

                <div class="row">
                    <input  type="hidden" name="id" value="<?= $id ?>">

                    <div class="col-lg-6 col-12 mb-30">
                        <span class="title">Tên Sự kiện </span><br>
                    ...
                    <div class="col-lg-6 col-12 mb-30">
                        <span class="title">Hình Ảnh Sự kiện </span><br>
