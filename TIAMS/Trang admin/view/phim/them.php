    ...
    <div class="row justify-content-between align-items-center mb-10">
        ...
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3>Sự Kiện <span>/ Thêm Sự Kiện</span></h3>
            </div>
    ...
    <form action="index.php?act=themphim" method="post"  enctype="multipart/form-data">
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                    ...
                    <h4 class="title">Thêm  Sự kiện</h4>

                    <div class="row">
                        <div class="col-lg-6 col-12 mb-30"><input class="form-control" type="text" placeholder="Tên Sự Kiện" name="tieu_de"></div>
                        ...
                        <div class="col-lg-6 col-12 mb-30">
                            <select name="id_loai" id="" class="form-control">
                                <option value="0">Chọn Thể Loại Sự Kiện</option>
                    ...
                    <div class="product-upload-gallery row flex-wrap">
                        ...
                        <div class="row">
                            <div class="d-flex flex-wrap justify-content-end col mbn-10">
                                ...
                                <button class="button button-outline button-primary mb-10 ml-10 mr-0" ><a href="index.php?act=QLphim">Quản Trị Sự Kiện</a></button>
                            </div>
