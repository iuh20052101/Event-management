...
<div class="content-body">
    ...
    <div class="row">
        ...
        <?php }else{
            echo '<h1>Chào mừng '.$_SESSION['user1']['name'].' đến với trang làm việc của TIAM EVENTS</h1>';
        } ?>
