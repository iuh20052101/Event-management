            ...
            <div class="side-header-inner custom-scroll">
                ...
                <nav class="side-header-menu" id="side-header-menu">
                    <ul>
                        ...
                        <li><a href="index.php?act=QLloaiphim"><i class="fa fa-tag" ></i> <span>Quản Lý Loại Sự Kiện</span></a></li>
                        <li><a href="index.php?act=QLphim"><i class="fa fa-film"></i> <span>Quản Lý Sự Kiện</span></a></li>
                        ...
                        <ul class="side-header-sub-menu">
                            ...
                            <li><a href="index.php?act=updateuser"><i class="fa fa-users"></i> <span>Nhân Viên</span></a></li> <!-- Dòng mới -->
                        </ul>
                    </li>
                        ...
                        <?php if ($_SESSION['user1']['vai_tro'] ==2){ ?>
                            <li class="has-sub-menu"><a href="#"><i class="fa fa-line-chart" ></i> <span>Theo Dõi Danh Thu</span></a>
                                <ul class="side-header-sub-menu">
                                    <li><a href="index.php?act=DTdh&&trang=1"><i class="fa fa-line-chart" ></i><span>Danh Thu Sự Kiện</span></a></li>
                        ...
                        <li class="has-sub-menu"><a href="#"><i class="ti-shopping-cart"></i> <span>Quản Lý Vé Xem Sự Kiện</span></a>
                            <ul class="side-header-sub-menu">
